...
/*----------------- TimeSyncPacket32khz -----------------*/
    ...
    {
        return call PacketTimeStamp32khz.isValid(msg) && getFooter(msg)->timestamp != CC1200_INVALID_TIMESTAMP;
    }
...
/*----------------- TimeSyncPacketMilli -----------------*/
    ...
    {
        return call PacketTimeStampMilli.isValid(msg) && getFooter(msg)->timestamp != CC1200_INVALID_TIMESTAMP;
    }
