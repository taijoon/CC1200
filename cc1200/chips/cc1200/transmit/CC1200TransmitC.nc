...
implementation {
  ...
  CC1200TransmitP.SIDLE       -> Spi.SIDLE;
  CC1200TransmitP.STX       -> Spi.STX;
  CC1200TransmitP.SRX       -> Spi.SRX;
  CC1200TransmitP.SFTX       -> Spi.SFTX;
  CC1200TransmitP.SFRX       -> Spi.SFRX;
  CC1200TransmitP.TXFIRST       -> Spi.TXFIRST;
  CC1200TransmitP.TXLAST       -> Spi.TXLAST;
  CC1200TransmitP.MARCSTATE       -> Spi.MARCSTATE;
