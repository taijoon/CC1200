...
implementation {
  ...
  // Create by TJ
  CC1200ReceiveP.SRES -> Spi.SRES;
  CC1200ReceiveP.SRX -> Spi.SRX;
  CC1200ReceiveP.SIDLE -> Spi.SIDLE;
  CC1200ReceiveP.SFRX -> Spi.SFRX;
  CC1200ReceiveP.SFTX -> Spi.SFTX;
  CC1200ReceiveP.NUM_RXBYTES -> Spi.NUM_RXBYTES;
  CC1200ReceiveP.MARCSTATE -> Spi.MARCSTATE;
  CC1200ReceiveP.RXFIRST -> Spi.RXFIRST;
  CC1200ReceiveP.RXLAST -> Spi.RXLAST;
