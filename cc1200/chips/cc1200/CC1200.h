...
enum cc1200_enums {
  ...
  CC1200_TIME_ACK_TURNAROUND = 4, // jiffies
  CC1200_TIME_VREN = 10,          // jiffies
  CC1200_TIME_SYMBOL = 1,         // 2 symbols / jiffy
  CC1200_BACKOFF_PERIOD = ( 10 / CC1200_TIME_SYMBOL ), // symbols
  CC1200_MIN_BACKOFF = ( 10 / CC1200_TIME_SYMBOL ),  // platform specific?
  CC1200_ACK_WAIT_DELAY = 128,    // jiffies
};
